...
if (!OPENAI_API_KEY) {
    throw new Error("OpenAI API Key is missing. Add it to your .env file as OPENAI_API_KEY.");
}
...
app.onRequest((context) => {
    ...
    context.set.headers = {
        "Access-Control-Allow-Origin": "http://localhost:5173", // Adjust to your frontend origin
